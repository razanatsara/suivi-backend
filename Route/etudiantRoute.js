...
router.get(
  '/annee/:annee/direction/:direction/typeFormation/:typeFormation/parcours/:parcours',
  etudiantController.getEtudiantParcours
);
// obtenir etudiant selon leur nom complet
router.get('/nomComplet/:nomComplet', etudiantController.getEtudiantComplet);
